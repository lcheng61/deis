Vagrant.configure("2") do |config|
  ...
  # Ubuntu 12.04.4 LTS with 3.11 kernel, Docker, and Deis images
  config.vm.box = "deis-precise64"
  config.vm.box_url = "https://s3-us-west-2.amazonaws.com/opdemand/deis-controller-0.5.1.box"
